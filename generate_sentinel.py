...
OPERATION SENTINEL - Battlefield Simulation Demo Scenario.
"""
...
def create_scenario_docx():
    ...
    t = doc.add_heading('OPERATION SENTINEL', level=0)
    ...
    toc = [
        ...
        '2. Scenariusz: OPERATION SENTINEL',
    ...
    # 2. SCENARIUSZ
    # ═══════════════════════════════════════════════════
    dh(doc, '2. Scenariusz: OPERATION SENTINEL', 1)
    doc.add_paragraph(
    ...
    dtable(doc,
        ...
        [
            ['Wywiad Agent', 'SENTINEL Intel', 'RadarDetections, DroneObservations, SigintIntercepts',
             'Analiza zagrożeń, korelacja danych wywiadowczych'],
            ['Logistics Agent', 'SENTINEL Supply', 'AmmoLogistics, VehicleStatus, WeatherData',
             'Status zaopatrzenia, optymalizacja tras dostaw'],
            ['Health Agent', 'SENTINEL Medic', 'SoldierHealth, VehicleStatus',
    ...
    steps = [
        ('Otwarcie (2 min)',
         ...
         'Przed nami operacja SENTINEL – obrona strategicznego węzła komunikacyjnego."'),
        ...
        ('Data Agent – wywiad (4 min)',
         'Otwarcie Data Agent (SENTINEL Intel). Zadanie 2-3 pytań w języku naturalnym. '
    ...
    dtable(doc,
        ...
        [
            ...
            ['Workspace', 'Dedykowany workspace „SENTINEL"', 'Separation of concerns'],
            ...
            ['Microsoft Teams', 'Kanał „SENTINEL-OPS"', 'Adaptive Cards'],
    ...
    doc.add_paragraph(
        'Demonstracja OPERATION SENTINEL pokazuje, jak Microsoft Fabric transformuje '
    ...
    path = os.path.join(OUT, 'SENTINEL_Scenario_Demo.docx')
    doc.save(path)
...
def create_scenario_pptx():
    ...
    p2col(prs, 'OPERATION SENTINEL – Scenariusz',
    ...
    # -- Slide 16: Thank you --
    ptitle(prs, 'OPERATION SENTINEL', 'Gotowi do demonstracji?\nPytania i dyskusja')

    path = os.path.join(OUT, 'SENTINEL_Scenario_Demo.pptx')
    prs.save(path)
    print(f"Created: {path}")
    return path
...
if __name__ == '__main__':
    print("Generating OPERATION SENTINEL documents...")
