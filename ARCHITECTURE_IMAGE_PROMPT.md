# OPERATION SENTINEL — Generowanie obrazu architektury
...
```
Create a professional military-themed system architecture diagram for "OPERATION SENTINEL" 
...
Text: Use English labels. Title: "OPERATION SENTINEL — Microsoft Fabric Architecture".
...
```
Schemat architektury systemu OPERATION SENTINEL opartego na Microsoft Fabric.
