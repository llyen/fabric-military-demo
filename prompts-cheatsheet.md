...
z `fabric-military-demo` (OPERATION SENTINEL).
...
```text
Wygeneruj `generate_SENTINEL.py` (lub `generate_<scenariusz>.py`), który
...
Po napisaniu uruchom: `pip install python-docx python-pptx && python generate_SENTINEL.py`.
```
