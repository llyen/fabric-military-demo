"""
OPERATION SENTINEL – Battlefield Data Simulator
...
# ── Geographic center: Poligon Northgate, Poland ──
# (real Polish military training area – 53.53°N, 15.78°E)
CENTER_LAT = 53.530
CENTER_LON = 15.780
SECTOR_RADIUS_KM = 8.0

# Sectors (named areas of operations) – all within Northgate Training Area
SECTORS = {
...
#   Northgate town: 53.53°N, 15.80°E
...
def generate_fabric_notebook(output_dir: str):
    ...
    code = '''# ═══════════════════════════════════════════════════════════════
# OPERATION SENTINEL – Fabric Notebook: Real-Time Data Sender
# ═══════════════════════════════════════════════════════════════
...
EVENT_HUB_NAME = "SENTINEL-events"
LAKEHOUSE_PATH = "abfss://<workspace>@onelake.dfs.fabric.microsoft.com/<lakehouse>/Files/SENTINEL/"
...
def generate_kql_create_tables(output_dir: str):
    ...
    kql = '''// ═══════════════════════════════════════════════════════════════
// OPERATION SENTINEL – KQL Table Definitions for Eventhouse
...
if __name__ == '__main__':
    ...
    print("=" * 60)
    print("OPERATION SENTINEL – Dataset Generator")
    print("=" * 60)
    ...
    print(f"  Location:               Poligon Northgate, Poland")
